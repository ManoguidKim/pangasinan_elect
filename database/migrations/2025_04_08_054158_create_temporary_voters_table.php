...
return new class extends Migration
{
    ...
    {
        Schema::create('temporary_voters', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('remarks', 500)->nullable()->default('Ally');
            $table->integer('is_guiconsulta')->default(0);
    ...
    {
        Schema::dropIfExists('temporary_voters');
    }
};

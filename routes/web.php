...
Route::middleware([
    ...
    Route::post('admin/manage/district/edit/{district}', [DistrictController::class, 'update'])->name('admin-manage-district-update')->middleware(['isSuperAdmin']);
    ...
    Route::get('system/admin/qr/scanlogs/report', [ScanlogController::class, 'scanlogsReport'])->name('system-admin-qr-scanlogs-report')->middleware(['isAdmin']);

<x-app-layout>
    ...
    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">Create new designation</h3>


    <form action="{{ route('system-admin-voter-designation-create') }}" method="post">
        @csrf

<x-app-layout>
    ...
    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">Update barangay details</h3>


    <form action="{{ route('admin-barangay-update', $barangay->id) }}" method="post">
        @csrf

<x-app-layout>
    ...
    <!-- Card Data -->
    <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div class="w-full">
            <div class="max-full p-8 bg-indigo-100 border border-dashed rounded-lg dark:bg-gray-800 dark:border-gray-700 flex items-center h-52">
                <div class="flex-1">
                    <a href="#">
                        <h6 class="mb-3 text-2xl font-semibold tracking-tight text-gray-600 dark:text-white uppercase">Total Voters = {{ number_format($totalActiveVoter) }}</h6>
                    </a>
                </div>
        ...
        <div class="w-full">
            <div class="max-full p-8 bg-green-100 border border-dashed rounded-lg dark:bg-gray-800 dark:border-gray-700 flex items-center h-52">
                <div class="flex-1">
                    <a href="#">
                        <h6 class="mb-3 text-2xl font-semibold tracking-tight text-gray-600 dark:text-white uppercase">Total Ally = {{ number_format($totalAllyVoter) }}</h6>
                    </a>
                </div>
                <svg class="w-12 h-12 text-gray-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="w-full">
            <div class="max-full p-8 bg-yellow-100 border border-dashed rounded-lg dark:bg-gray-800 dark:border-gray-700 flex items-center h-52">
                <div class="flex-1">
                    <a href="#">
                        <h6 class="mb-3 text-2xl font-semibold tracking-tight text-gray-600 dark:text-white uppercase">Scanned Percentage ({{ $scannedSummary->scan_percentage }}%)</h6>
                    </a>
                </div>

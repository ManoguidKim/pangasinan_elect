<x-app-layout>
    ...
    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">System Activity Logs ({{ $municipalityName }})</h3>
    ...
    <livewire:systemadmin.log.activity-logs-show-livewire :municipalId="$municipalId" />
</x-app-layout>
<div>
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Voter Designation</a>
                </div>
            </li>
        </ol>
    </nav>

    <h2 class="mb-4 text-3xl font-bold leading-none tracking-tight text-gray-500 md:text-3xl dark:text-white">Assingning Designation to {{ $voterName }}</h2>
    <form wire:submit.prevent="createVoterDesignation">
        <div class="grid grid-cols-3 gap-4 mb-4">
            ...
            <div class="w-full">
                ...
                <select name="designation" class="mb-2 bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model="designation">
    ...
    <div class="relative overflow-x-auto sm:rounded-lg">
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                @foreach ($voterDesignations as $vd)

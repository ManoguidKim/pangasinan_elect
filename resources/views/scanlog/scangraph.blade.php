<x-app-layout>
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Scan Details</a>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="p-4 mb-3 rounded-lg bg-green-50 dark:bg-gray-800 border border-dashed">
        <p class="text-sm text-gray-500 dark:text-gray-400"><strong>Scan Log Entry: </strong> This is a detailed record of successful QR code scans conducted in each barangay, providing a comprehensive comparison between the actual number of scans and the expected target. The data highlights the scanning activity across the municipality, offering insights into how each barangay performs in terms of meeting or exceeding the projected QR code scan counts.</p>
    </div>
    ...
    var options3 = {
        ...
        plotOptions: {
            bar: {
                ...
                columnWidth: '50%' // Optional: Adjust column width
            }
        },
        colors: ['#4052d6'],
        dataLabels: {
